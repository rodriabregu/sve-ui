...
<script lang="ts">
	...
	let { color, variant, class: cls, children, ...rest }: Props = $props();

	const className = $derived(alertVariants({ color, variant, class: cls }));
