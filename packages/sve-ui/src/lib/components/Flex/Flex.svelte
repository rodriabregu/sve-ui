...
<style>
  ...
  .sve-flex--row            { flex-direction: row; }
  .sve-flex--column         { flex-direction: column; }
  .sve-flex--row-reverse    { flex-direction: row-reverse; }
  .sve-flex--column-reverse { flex-direction: column-reverse; }

  .sve-flex--wrap { flex-wrap: wrap; }

  .sve-flex--align-start    { align-items: flex-start; }
  .sve-flex--align-center   { align-items: center; }
  .sve-flex--align-end      { align-items: flex-end; }
  .sve-flex--align-stretch  { align-items: stretch; }
  .sve-flex--align-baseline { align-items: baseline; }

  .sve-flex--justify-start   { justify-content: flex-start; }
  .sve-flex--justify-center  { justify-content: center; }
  .sve-flex--justify-end     { justify-content: flex-end; }
  .sve-flex--justify-between { justify-content: space-between; }
  .sve-flex--justify-around  { justify-content: space-around; }
  .sve-flex--justify-evenly  { justify-content: space-evenly; }
</style>
