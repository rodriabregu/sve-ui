/**
 * TimeRangeField namespace — sve-ui styled wrappers over bits-ui TimeRangeField.
 *
 ...
 * read aloud between two times adds nothing.
 *
...
// The Segment is shared with TimeField: Bits re-exports the identical
// module to both namespaces, so one styled implementation serves each.
export { Segment } from '../TimeField/index.js';
