...
<script lang="ts">
	...
	let { variant, color, size, class: cls, children, ...rest }: Props = $props();

	const className = $derived(badgeVariants({ variant, color, size, class: cls }));
</script>
