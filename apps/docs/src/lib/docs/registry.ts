...
export const componentGroups: ComponentGroup[] = [
	...
	},
	{
		...
		items: [
			...
			{ slug: 'date-picker', name: 'Date Picker', blurb: 'Calendar-based date selection.', status: 'new', ready: true },
			...
			{ slug: 'date-range-picker', name: 'Date Range Picker', blurb: 'Calendar-based range selection.', status: 'new', ready: true },
