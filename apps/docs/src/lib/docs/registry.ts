...
export const componentGroups: ComponentGroup[] = [
	{
		...
		items: [
			...
			{ slug: 'text', name: 'Text', blurb: 'Body copy with size and tone.', ready: true },
			{
				slug: 'skeleton',
				name: 'Skeleton',
				blurb: 'Loading placeholder for content.',
				status: 'new',
				ready: true
			}
		]
	},
	{
		...
		items: [
			...
			},
			{
				slug: 'select',
				name: 'Select',
				blurb: 'Listbox for picking one option.',
				status: 'new',
				ready: true
			},
			{
				slug: 'combobox',
				name: 'Combobox',
				blurb: 'Filterable autocomplete select.',
				status: 'new',
				ready: true
			},
			{
				slug: 'slider',
				name: 'Slider',
				blurb: 'Pick a value along a range.',
				status: 'new',
				ready: true
			},
			{
			...
			},
			{
				slug: 'date-picker',
				name: 'Date Picker',
				blurb: 'Calendar-based date selection.',
				status: 'new',
				ready: true
			},
			{
			...
			},
			{
				...
				blurb: 'Segmented date range input.',
				status: 'new',
				ready: true
			},
			{
				...
				blurb: 'Calendar-based range selection.',
				status: 'new',
				ready: true
			},
			{
			...
			},
			{
				...
				blurb: 'Segmented time range input.',
				status: 'new',
				ready: true
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				slug: 'progress',
				name: 'Progress',
				blurb: 'Determinate progress bar.',
				status: 'new',
				ready: true
			},
			{
				slug: 'meter',
				name: 'Meter',
				blurb: 'Bounded scalar measurement.',
				status: 'new',
				ready: true
			}
		]
		...
		items: [
			{
				slug: 'tabs',
				name: 'Tabs',
				blurb: 'Switch between related panels.',
				status: 'new',
				ready: true
			},
			{
				slug: 'accordion',
				name: 'Accordion',
				blurb: 'Collapsible disclosure sections.',
				status: 'new',
				ready: true
			},
			{
				slug: 'sidebar',
				name: 'Sidebar',
				blurb: 'Composable app-shell navigation.',
				status: 'new',
				ready: true
			},
			{
			...
			},
			{
				...
				blurb: 'Top-level nav with menus.',
				status: 'new',
				ready: true
			},
			{
			...
			},
			{
				slug: 'collapsible',
				name: 'Collapsible',
				blurb: 'Single expand/collapse region.',
				status: 'new',
				ready: true
			},
			{
				slug: 'toolbar',
				name: 'Toolbar',
				blurb: 'Grouped controls container.',
				status: 'new',
				ready: true
			}
		]
	},
	{
		...
		items: [
			...
			},
			{
				slug: 'command',
				name: 'Command',
				blurb: 'Command palette / fuzzy search menu.',
				status: 'new',
				ready: true
			},
		...
		items: [
			{
				slug: 'stack',
				name: 'Stack',
				blurb: 'Vertical spacing primitive.',
				status: 'new',
				ready: true
			},
			{
				slug: 'flex',
				name: 'Flex',
				blurb: 'Flexbox layout primitive.',
				status: 'new',
				ready: true
			},
			{
				slug: 'separator',
				name: 'Separator',
				blurb: 'Visual or semantic divider.',
				status: 'new',
				ready: true
			},
			{
				slug: 'scroll-area',
				name: 'Scroll Area',
				blurb: 'Styled custom scroll container.',
				status: 'new',
				ready: true
			},
			{
