		...
		<div>
			...
			>
				...
				<code class="doc-mono" style="font-size: 14.5px; color: var(--doc-primary-text);"
					>pnpm&nbsp;add&nbsp;sve-ui</code
				>, import, ship. Theme it all with CSS variables.
			</p>
		...
		<div class="sve-float relative" style="animation: sveFloat 7s ease-in-out infinite;">
			...
			>
				...
				>
					...
					<span class="doc-mono ml-2" style="font-size: 12px; color: var(--doc-fg-subtle);"
						>+page.svelte</span
					>
				</div>
				<div class="p-6">
					...
					<Heading level={3} size="lg" weight="bold" style="letter-spacing: -0.02em;"
						>Upgrade your workspace</Heading
					>
					<Text size="sm" class="mb-4 mt-1" style="color: var(--doc-fg-muted);"
						>Unlimited components and priority support.</Text
					>
					...
					<Text
						...
						weight="medium"
						class="mb-1.5 block"
						style="color: var(--doc-fg-subtle);">Work email</Text
					>
					...
					<div class="flex items-center gap-2.5">
						...
						<div class="ml-1 flex">
							<span
								...
								style="background: linear-gradient(135deg, #f56565, #ed8936); border: 2px solid var(--doc-surface);"
							></span>
							<span
								class="-ml-2.5 h-[30px] w-[30px] rounded-full"
								style="background: linear-gradient(135deg, #8b5cf6, #3b82f6); border: 2px solid var(--doc-surface);"
							></span>
							<span
								class="-ml-2.5 inline-flex h-[30px] w-[30px] items-center justify-center rounded-full"
								style="background: var(--doc-surface-2); border: 2px solid var(--doc-surface); font-size: 10px; font-weight: 700; color: var(--doc-fg-muted);"
								>+9</span
							>
						</div>
					</div>
...
<section class="mx-auto max-w-[1180px] px-7" style="padding-bottom: 72px;">
	<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
		{#each [{ icon: 'tailwind', tone: 'var(--doc-primary-text)', surf: 'color-mix(in srgb, var(--sve-color-primary) 14%, transparent)', title: 'No Tailwind', body: 'Styles ship with the package. Your project needs no Tailwind, no PostCSS, no utility classes.' }, { icon: 'zap', tone: 'var(--doc-warning)', surf: 'var(--doc-warning-surf)', title: 'Zero config', body: 'Install, import the stylesheet once, and use. No setup step, no CLI, no copy-pasting source.' }, { icon: 'a11y', tone: 'var(--doc-success)', surf: 'var(--doc-success-surf)', title: 'Accessible', body: 'Dialog, Dropdown, Tooltip & Popover are built on Bits UI — WAI-ARIA, focus traps, keyboard nav.' }, { icon: 'palette', tone: 'var(--doc-primary-text)', surf: 'color-mix(in srgb, var(--sve-color-primary) 14%, transparent)', title: 'Themeable', body: 'Every color, radius & spacing value is a --sve-* variable. Light & dark out of the box.' }] as f (f.title)}
			<div
				style="padding: 24px 22px; border-radius: 16px; background: var(--doc-surface); border: 1px solid var(--doc-border);"
			>
				<div
					class="mb-4 inline-flex h-10 w-10 items-center justify-center"
					style="border-radius: 11px; background: {f.surf}; color: {f.tone};"
				>
					{#if f.icon === 'tailwind'}
						<svg
							width="20"
							...
							><path d="m3 21 18-18" /><path
								d="M7 7c-2 0-3 1-3.5 3 .75-1 1.5-1.4 2.5-1.2.6.1 1 .5 1.5 1.1.8.9 1.7 1.9 3.5 1.9 2 0 3-1 3.5-3-.75 1-1.5 1.4-2.5 1.2-.6-.1-1-.5-1.5-1.1C13.2 8 12.3 7 10.5 7Z"
							/></svg
						>
					{:else if f.icon === 'zap'}
						<svg
							...
							stroke-linecap="round"
							stroke-linejoin="round"
							aria-hidden="true"><path d="M13 2 3 14h9l-1 8 10-12h-9l1-8Z" /></svg
						>
					{:else if f.icon === 'a11y'}
						<svg
							width="20"
							...
							stroke-linejoin="round"
							aria-hidden="true"
							><circle cx="12" cy="4.5" r="2" /><path
								d="M4 8.5h16M12 8.5v6M12 14.5 8 21M12 14.5 16 21"
							/></svg
						>
					{:else}
						<svg
							...
							stroke-linejoin="round"
							aria-hidden="true"
							><circle cx="13.5" cy="6.5" r="2.5" /><circle cx="17.5" cy="12" r="2.5" /><circle
								cx="8.5"
								cy="7.5"
								r="2.5"
							/><circle cx="6.5" cy="13" r="2.5" /><path
								d="M12 22a10 10 0 1 1 0-20c4 0 6 2.5 6 5s-2 3-4 3h-1.5a2.5 2.5 0 0 0 0 5c1.5 0 2 1 2 2a3 3 0 0 1-2.5 5Z"
							/></svg
						>
					{/if}
				</div>
				<Heading level={3} size="md" weight="bold" class="mb-1.5" style="letter-spacing: -0.01em;"
					>{f.title}</Heading
				>
...
<section id="components" class="mx-auto max-w-[1180px] px-7 py-8">
	<div class="mx-auto mb-11 max-w-[620px] text-center">
		...
		>
			Everything you need,<br />already styled.
		</h2>
		<Text size="lg" align="center" style="color: var(--doc-fg-muted); line-height: 1.55;"
			>Display, form, feedback and overlays — composed, accessible and ready to drop in. Every
			example below is the real component.</Text
		>
	</div>
	...
	{#snippet panel(label: string, hint: string | undefined)}
		<div class="mb-4 flex items-center gap-2">
			<span
				style="font-size: 11px; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: var(--doc-fg-subtle);"
				>{label}</span
			>
	...
	<div class="grid grid-cols-1 gap-4 md:grid-cols-6">
		...
		<div
			class="md:col-span-4"
			style="padding: 22px; border-radius: 16px; background: var(--doc-surface); border: 1px solid var(--doc-border); box-shadow: var(--doc-shadow);"
		>
		...
		>
			...
			<Text
				...
				weight="medium"
				class="mb-1.5 block"
				style="color: var(--doc-fg-muted);">Email</Text
			>
			...
			<Text
				...
				weight="medium"
				class="mb-1.5 block"
				style="color: var(--doc-fg-muted);">Password</Text
			>
		...
		>
			...
			<Text size="sm" class="mt-2" style="color: var(--doc-fg-muted); line-height: 1.55;"
				>Body copy in a comfortable measure with muted foreground for secondary information.</Text
			>
		</div>
	...
	<div class="mb-4 mt-9 flex items-center gap-2.5">
		<span
			style="font-size: 12px; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: var(--doc-fg-subtle);"
			>Overlays</span
		>
		<span style="font-size: 12.5px; color: var(--doc-fg-subtle);"
			>— real Bits UI overlays. Open them.</span
		>
	...
	<Tooltip.Provider>
		<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
			<!-- Dialog -->
			<div
				class="flex min-h-[180px] flex-col"
				style="padding: 22px; border-radius: 16px; background: var(--doc-surface); border: 1px solid var(--doc-border); box-shadow: var(--doc-shadow);"
			>
				<span
					class="mb-4"
						...
						<Dialog.Content>
							...
							<div class="mt-4 flex justify-end gap-2">
								...
								<Button
									...
									color="danger"
									size="sm"
									onclick={() => (dialogOpen = false)}>Delete</Button
								>
							</div>
						</Dialog.Content>
					</Dialog.Root>
	...
	<div class="mx-auto max-w-[1180px] px-7" style="padding-top: 70px; padding-bottom: 70px;">
		<div class="grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
			<div>
				...
				<h2
					class="mb-3.5 mt-3"
					style="font-size: 36px; font-weight: 800; letter-spacing: -0.03em; line-height: 1.1; color: var(--doc-fg);"
				>
					Yours to theme —<br />live, right here.
				</h2>
				<Text size="lg" class="mb-5" style="color: var(--doc-fg-muted); line-height: 1.6;"
					>Every token is a CSS custom property. Recolor the whole component cluster or flip its
					theme — no rebuild, no config. Try it:</Text
				>

				<div class="mb-5 flex flex-wrap items-center gap-3.5">
					<div class="flex items-center gap-2.5">
						<span
							style="font-size: 12px; font-weight: 600; color: var(--doc-fg-subtle); text-transform: uppercase; letter-spacing: 0.08em;"
							>Accent</span
						>
						{#each ACCENTS as sw (sw.id)}
							<button
								...
								style="border-radius: 9px; border: 2px solid var(--doc-surface); background: {sw.fill}; outline-offset: 2px; outline: {accentId ===
								sw.id
									? `2px solid ${sw.fill}`
				...
				<div
					class="doc-mono"
					style="border-radius: 12px; background: var(--doc-code-bg); border: 1px solid var(--doc-border); padding: 16px 18px; font-size: 13px; line-height: 1.7;"
				>
					<div style="color: #7c7c8a;">:root &#123;</div>
					<div style="padding-left: 16px;">
						<span style="color: #f6ad55;">--sve-color-primary</span><span style="color: #e6e6ec;"
							>:
						</span><span style="color: #34d399;">{acc.fill}</span><span style="color: #e6e6ec;"
							>;</span
						>
					</div>
					<div style="padding-left: 16px;">
						<span style="color: #f6ad55;">--sve-radius-md</span><span style="color: #e6e6ec;"
							>:
						</span><span style="color: #34d399;">0.375rem</span><span style="color: #e6e6ec;"
							>;</span
						>
					</div>
			...
			<ThemeProvider colorScheme={demoScheme}>
				<div
					style="{accentStyle} padding: 30px; border-radius: 18px; background: var(--doc-surface); border: 1px solid var(--doc-border); box-shadow: var(--doc-shadow);"
				>
					<div class="mb-5 flex items-center justify-between">
						<div class="flex items-center gap-2.5">
							<span
								class="inline-flex h-10 w-10 items-center justify-center font-extrabold"
								style="border-radius: 11px; background: var(--sve-color-primary); color: var(--sve-color-primary-foreground);"
								>S</span
							>
							<div>
						...
						<Badge color="primary" variant="subtle"
							>{demoScheme === 'dark' ? 'Dark' : 'Light'}</Badge
						>
					</div>
	...
	<div class="grid items-center gap-12 lg:grid-cols-[0.85fr_1.15fr]">
		<div>
			...
			<h2
				...
				style="font-size: 36px; font-weight: 800; letter-spacing: -0.03em; line-height: 1.1; color: var(--doc-fg);"
			>
				Three lines.<br />That's the setup.
			</h2>
			<Text size="lg" class="mb-4" style="color: var(--doc-fg-muted); line-height: 1.6;"
				>No <code class="doc-mono" style="font-size: 13px; color: var(--doc-primary-text);"
					>tailwind.config</code
				>, no PostCSS plugins, no component scaffolding. Add the package, import the stylesheet
				once, and use the components.</Text
			>
		...
		<div
			style="border-radius: 16px; background: var(--doc-code-bg); border: 1px solid var(--doc-border); overflow: hidden; box-shadow: var(--doc-shadow);"
		>
			<div
				class="flex items-center gap-2"
				style="padding: 12px 16px; border-bottom: 1px solid rgba(255,255,255,0.06);"
			>
				<span class="h-[11px] w-[11px] rounded-full" style="background: #ff5f57;"></span>
				<span class="h-[11px] w-[11px] rounded-full" style="background: #febc2e;"></span>
				<span class="h-[11px] w-[11px] rounded-full" style="background: #28c840;"></span>
			...
			<pre
				class="doc-mono m-0 overflow-x-auto"
				style="padding: 20px 22px; font-size: 13.5px; line-height: 1.85; color: #e6e6ec;"><span
					style="color: #5e6a7a;"># 1 · install — no Tailwind needed</span
				>
...
<span style="color: #c792ea;">import</span> <span style="color: #f6ad55;">'sve-ui/theme.css'</span
				><span style="color: #7c7c8a;">;</span>

<span style="color: #5e6a7a;">// 3 · use it — zero config</span>
<span style="color: #c792ea;">import</span> &#123; <span style="color: #82aaff;">Button</span
				>, <span style="color: #82aaff;">Dialog</span> &#125; <span style="color: #c792ea;"
					>from</span
				> <span style="color: #f6ad55;">'sve-ui'</span><span style="color: #7c7c8a;">;</span>

<span style="color: #7c7c8a;">&lt;</span><span style="color: #f07178;">Button</span> <span
					style="color: #ffcb6b;">color</span
				>=<span style="color: #c3e88d;">"primary"</span><span style="color: #7c7c8a;">&gt;</span
				>Ship it<span style="color: #7c7c8a;">&lt;/</span><span style="color: #f07178;">Button</span
				><span style="color: #7c7c8a;">&gt;</span></pre>
		</div>
	</div>
</section>
	...
	<div class="mx-auto max-w-[1080px] px-7" style="padding-top: 70px; padding-bottom: 70px;">
		<div class="mx-auto mb-11 max-w-[560px] text-center">
			...
			<h2
				...
				style="font-size: 36px; font-weight: 800; letter-spacing: -0.03em; line-height: 1.1; color: var(--doc-fg);"
			>
				The only one that<br />skips Tailwind.
			</h2>
			<Text size="lg" align="center" style="color: var(--doc-fg-muted); line-height: 1.55;"
				>Most Svelte libraries need Tailwind wired into your project. Sve·UI doesn't.</Text
			>
		</div>
		...
		{#snippet yes()}
			<span
				...
				style="border-radius: 50%; background: var(--doc-success-surf); color: var(--doc-success);"
			>
				<svg
					width="14"
					height="14"
		...
		{#snippet no(note: string)}
			<span
				class="inline-flex h-6 w-6 items-center justify-center"
				style="border-radius: 50%; background: var(--doc-surface-2); color: var(--doc-fg-subtle);"
			>
				<svg
					width="13"
					height="13"
			...
			{#if note}<div style="font-size: 11px; color: var(--doc-fg-subtle); margin-top: 4px;">
					{note}
				</div>{/if}
		{/snippet}
		...
		<div
			...
			style="border-radius: 16px; border: 1px solid var(--doc-border); background: var(--doc-surface); box-shadow: var(--doc-shadow);"
		>
			<table style="width: 100%; border-collapse: collapse; font-size: 14px; min-width: 560px;">
				<thead>
					<tr>
						<th
							style="text-align: left; padding: 16px 20px; font-weight: 600; color: var(--doc-fg-muted); font-size: 13px; background: var(--doc-surface-2);"
						></th>
						<th
							style="padding: 16px 14px; background: color-mix(in srgb, var(--sve-color-primary) 12%, var(--doc-surface)); border-left: 1px solid var(--doc-border); border-right: 1px solid var(--doc-border);"
						>
							<div
								class="flex items-center justify-center gap-2"
								style="font-weight: 800; font-size: 15px; color: var(--doc-primary-text);"
							>
								<span
									class="inline-flex h-5 w-5 items-center justify-center"
									style="border-radius: 6px; background: var(--sve-color-primary); color: var(--sve-color-primary-foreground); font-size: 12px;"
									>S</span
								>Sve·UI
							</div>
						</th>
						<th
							style="padding: 16px 14px; font-weight: 600; color: var(--doc-fg-muted); background: var(--doc-surface-2);"
							>shadcn-svelte</th
						>
						<th
							style="padding: 16px 14px; font-weight: 600; color: var(--doc-fg-muted); background: var(--doc-surface-2);"
				...
				<tbody>
					{#each [{ label: 'No Tailwind in your project', cells: [true, 'required', 'required', 'required'] }, { label: 'Zero config to start', cells: [true, 'CLI setup', 'config', 'config'] }, { label: 'Styled out of the box', cells: [true, 'copy & own', true, true] }, { label: 'Accessible (Bits UI / ARIA)', cells: [true, true, 'partial', 'partial'] }, { label: 'Theme via CSS variables', cells: [true, 'TW config', '', 'TW config'] }, { label: 'Svelte 5 + Runes', cells: [true, true, true, true] }, { label: 'Light + dark included', cells: [true, true, 'partial', true] }] as row (row.label)}
						<tr style="border-top: 1px solid var(--doc-border);">
							<td
								style="text-align: left; padding: 15px 20px; font-weight: 600; color: var(--doc-fg);"
								>{row.label}</td
							>
		...
		<Text size="sm" align="center" class="mt-4" style="color: var(--doc-fg-subtle);"
			>Comparison reflects each library's default setup. All are excellent — Sve·UI's wedge is the
			zero-config, no-Tailwind path.</Text
		>
	</div>
</section>
...
<!-- ===================== CLOSING CTA + TRUST ===================== -->
<section
	class="relative mx-auto max-w-[1180px] px-7 text-center"
	style="padding-top: 84px; padding-bottom: 70px;"
>
	<div
	...
	<div class="relative">
		<h2
			class="mb-3.5"
			style="font-size: 44px; font-weight: 800; letter-spacing: -0.035em; line-height: 1.06; color: var(--doc-fg);"
		>
			Ready to build?
		</h2>
		...
		<div
			...
			style="border: 1px solid var(--doc-border); border-radius: 12px; background: var(--doc-surface);"
		>
			<div class="flex items-center gap-2" style="padding: 12px 18px;">
				<svg
					...
					viewBox="0 0 24 24"
					fill="none"
					stroke="var(--doc-fg-muted)"
					stroke-width="2"
					stroke-linecap="round"
					stroke-linejoin="round"
					aria-hidden="true"
					><path d="m7.5 4.3 4.5-2.6 4.5 2.6v5.2L12 12 7.5 9.5z" transform="translate(0 1)" /><path
						d="M3 7.3 7.5 4.7 12 7.3v5.2L7.5 15 3 12.5z"
					/><path d="M12 7.3 16.5 4.7 21 7.3v5.2L16.5 15 12 12.5z" /></svg
				>
				<span class="doc-mono" style="font-size: 13px; font-weight: 500; color: var(--doc-fg);"
					>{VERSION}</span
				>
			</div>
			...
			<div class="flex items-center gap-2" style="padding: 12px 18px;">
				<svg
					...
					stroke-linejoin="round"
					aria-hidden="true"
					><path d="M12 3 4 6v5c0 5 3.5 8 8 10 4.5-2 8-5 8-10V6z" /><path d="m9 12 2 2 4-4" /></svg
				>
			...
			<a
				...
				style="padding: 12px 18px; color: var(--doc-fg);"
			>
				<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"
					><path
						d="M12 .5a12 12 0 0 0-3.8 23.4c.6.1.8-.3.8-.6v-2c-3.3.7-4-1.6-4-1.6-.6-1.4-1.3-1.8-1.3-1.8-1.1-.7 0-.7 0-.7 1.2 0 1.8 1.2 1.8 1.2 1 1.8 2.8 1.3 3.5 1 .1-.8.4-1.3.7-1.6-2.7-.3-5.5-1.3-5.5-5.9 0-1.3.5-2.4 1.2-3.2 0-.3-.5-1.5.2-3.2 0 0 1-.3 3.3 1.2a11.5 11.5 0 0 1 6 0C18 4.6 19 4.9 19 4.9c.7 1.7.2 2.9.1 3.2.8.8 1.2 1.9 1.2 3.2 0 4.6-2.8 5.6-5.5 5.9.4.4.8 1.1.8 2.2v3.3c0 .3.2.7.8.6A12 12 0 0 0 12 .5Z"
