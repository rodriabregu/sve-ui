...
<DocPage group={meta.group} name={meta.name} description={meta.blurb} {toc}>
	<section id="usage" class="sec">
		...
		<p class="sec__p">
			...
			<code class="ic">Item</code>, with a <code class="ic">Separator</code> between items. Root is
			a
			<code class="ic">&lt;nav&gt;</code> landmark labelled "Breadcrumb" by default — that label is what
			lets a screen reader user tell it apart from the site's main navigation.
		</p>
	...
	<section id="current" class="sec">
		...
		<p class="sec__p">
			...
			link to the page you are already on is a dead end, and a keyboard user should not have to tab through
			it.
		</p>
		<p class="sec__p">
			It also stops looking like a link, which is the honest signal: nothing happens if you click
			it.
		</p>
	</section>
	...
	<section id="separators" class="sec">
		...
		<p class="sec__p">
			...
			<code class="ic">role="presentation"</code>, so a screen reader reads "Home, Components,
			Breadcrumb" rather than "Home, slash, Components, slash, Breadcrumb". The glyph is visual
			punctuation; it means nothing spoken.
		</p>
	...
	<section id="why-custom" class="sec">
		...
		<p class="sec__p">
			The list is <code class="ic">&lt;ol&gt;</code>, not <code class="ic">&lt;ul&gt;</code>,
			because the order carries meaning — the trail is a sequence from root to current page.
			Reaching for a headless primitive here would add a dependency to reproduce what HTML already
			does correctly.
		</p>
	</section>
	...
	<section id="props" class="sec">
		...
		<p class="sec__p" style="margin-top:16px">
			<code class="ic">Breadcrumb.Link</code> — plus the native anchor attributes.
		</p>
		<PropsTable component="BreadcrumbLink" />
		<p class="sec__p" style="margin-top:16px">
			<code class="ic">List</code>, <code class="ic">Item</code> and
			<code class="ic">Separator</code> each take <code class="ic">class</code> plus their native attributes.
		</p>
	</section>
</DocPage>
