...
<DocPage group={meta.group} name={meta.name} description={meta.blurb} {toc}>
	<section id="usage" class="sec">
		...
		<Preview code={usageCode} align="start">
			<ScrollArea.Root type="always" style="height: 10rem; width: 14rem; border: 1px solid var(--doc-border); border-radius: 10px;">
				<ScrollArea.Viewport>
	...
	<section id="type" class="sec">
		...
		<p class="sec__p">
			Worth knowing: under <code class="ic">hover</code> the scrollbar is not merely transparent — it
			is <strong>not in the DOM at all</strong> until the pointer enters. That is Bits behaviour, and
			it is why the demo above uses <code class="ic">always</code>.
		</p>
	</section>
	...
	<section id="props" class="sec">
		...
		<p class="sec__p" style="margin-top:16px">
			<code class="ic">ScrollArea.Scrollbar</code> — <code class="ic">orientation</code> is required
			by Bits; render one per axis you want styled.
		</p>
