...
<DocPage group={meta.group} name={meta.name} description={meta.blurb} {toc}>
	...
	<section id="hourcycle" class="sec">
		...
		<p class="sec__p">
			Leave <code class="ic">hourCycle</code> unset and it follows the locale, which is almost
			always what you want — most of the world is on a 24-hour clock, so hardcoding
			<code class="ic">12</code> is a US-shaped assumption.
		</p>
		<p class="sec__p">
			It also changes the structure: a 12-hour clock adds a
			<code class="ic">dayPeriod</code> (AM/PM) segment and bounds the hour at 1–12, while a 24-hour clock
	...
	<section id="props" class="sec">
		...
		<p class="sec__p">
			<code class="ic">TimeField.Root</code> — <code class="ic">value</code> and
