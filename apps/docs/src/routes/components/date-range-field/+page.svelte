...
<DocPage group={meta.group} name={meta.name} description={meta.blurb} {toc}>
	...
	<section id="naming" class="sec">
		...
		<p class="sec__p">
			...
			<a href="/components/date-field">Date Field</a> the Input <em>is</em> the group and Bits does label
	...
	<section id="shared" class="sec">
		...
		<p class="sec__p">
			...
			<a href="/components/date-field">Date Field</a> uses — Bits re-exports the identical module to both
	...
	<section id="props" class="sec">
		...
		<p class="sec__p">
			<code class="ic">DateRangeField.Root</code> — <code class="ic">value</code> and
